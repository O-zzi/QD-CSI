...
const educationalContent = [
  {
    slug: 'padel-tennis',
    howToPlayContent: `• Played in doubles on an enclosed court (25% smaller than tennis)
...
• Games are played to 6 with a 2-game advantage needed to win a set`,
    scoringRulesContent: `• Same scoring as tennis: 15, 30, 40, and game
...
• Matches are typically best of 3 sets`,
    winningCriteriaContent: `• Win a match by being first to win 2 sets
...
• Ball is out if it hits the fence or goes over glass without bouncing first`,
    pointsSystemContent: `• Wins earn 25 ranking points
...
• Top players qualify for exclusive member tournaments`
  ...
  {
    slug: 'squash',
    howToPlayContent: `• Played between two players in a four-walled court
...
• Alternate shots until someone fails to return correctly`,
    scoringRulesContent: `• Point-a-rally scoring (PAR) to 11 points
...
• Server continues serving until they lose a rally`,
    winningCriteriaContent: `• Win a game by being first to 11 points (2-point lead required)
...
• A "stroke" is awarded when opponent prevents a fair shot (you win point)`,
    pointsSystemContent: `• Match wins earn 20 ranking points
...
• Maintain ranking by playing at least 2 matches per month`
  },
  {
    ...
    howToPlayContent: `• Requires focus, breath control, and steady positioning
...
• Range masters provide guidance for beginners`,
    scoringRulesContent: `• Target has 10 scoring rings (center = 10 points, outer = 1 point)
...
• Maximum possible score: 600 points`,
    winningCriteriaContent: `• Competitions decided by total points across all shots
...
• Consistency is key to success`,
    pointsSystemContent: `• Personal bests recorded for each session
...
• Safety certification earns 50 bonus points`
  },
  {
    ...
    howToPlayContent: `• Accommodates badminton, table tennis, yoga, dance classes
...
• Staff available for setup assistance`,
    scoringRulesContent: `• Badminton: Rally scoring to 21 points (win by 2)
...
• International rules apply for all sports`,
    winningCriteriaContent: `• Badminton matches are best of 3 games
...
• Private events have flexible arrangements`,
    pointsSystemContent: `• Regular class attendance earns 10 points per session
...
• Group booking discounts for members`
  ...
  {
    slug: 'bridge-room',
    howToPlayContent: `• Contract Bridge is a trick-taking card game for 4 players
...
• Declarer plays both their hand and dummy's exposed cards`,
    scoringRulesContent: `• Points awarded for tricks won beyond the first 6 ("book")
...
• Slam bonuses for bidding and making 12 or 13 tricks`,
    winningCriteriaContent: `• Win a rubber by being first to win 2 games
...
• Duplicate bridge scored on comparison with other tables`,
    pointsSystemContent: `• Regular play sessions earn 15 participation points
